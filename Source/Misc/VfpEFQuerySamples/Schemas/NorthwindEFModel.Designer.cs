...
[assembly: EdmRelationshipAttribute("NorthwindEFModel", "TerritoriesRegion", "Region", RelationshipMultiplicity.One, typeof(NorthwindEFModel.Region), "Territories", RelationshipMultiplicity.Many, typeof(NorthwindEFModel.Territory))]
[assembly: EdmRelationshipAttribute("NorthwindEFModel", "EmployeesTerritories", "Employees", RelationshipMultiplicity.Many, typeof(NorthwindEFModel.Employee), "Territories", RelationshipMultiplicity.Many, typeof(NorthwindEFModel.Territory))]
[assembly: EdmRelationshipAttribute("NorthwindEFModel", "Products_Supplier", "Supplier", RelationshipMultiplicity.ZeroOrOne, typeof(NorthwindEFModel.Supplier), "Products", RelationshipMultiplicity.Many, typeof(NorthwindEFModel.Product))]
[assembly: EdmRelationshipAttribute("NorthwindEFModel", "Products_Category", "Category", RelationshipMultiplicity.ZeroOrOne, typeof(NorthwindEFModel.Category), "Products", RelationshipMultiplicity.Many, typeof(NorthwindEFModel.Product))]
[assembly: EdmRelationshipAttribute("NorthwindEFModel", "CustomerOrders", "Customer", RelationshipMultiplicity.ZeroOrOne, typeof(NorthwindEFModel.Customer), "Orders", RelationshipMultiplicity.Many, typeof(NorthwindEFModel.Order))]
[assembly: EdmRelationshipAttribute("NorthwindEFModel", "Order_Details_Order", "Order", RelationshipMultiplicity.One, typeof(NorthwindEFModel.Order), "OrderDetails", RelationshipMultiplicity.Many, typeof(NorthwindEFModel.OrderDetail), true)]
[assembly: EdmRelationshipAttribute("NorthwindEFModel", "Order_Details_Product", "Product", RelationshipMultiplicity.One, typeof(NorthwindEFModel.Product), "OrderDetails", RelationshipMultiplicity.Many, typeof(NorthwindEFModel.OrderDetail), true)]
